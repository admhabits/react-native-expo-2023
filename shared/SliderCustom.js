...
export default class SliderBox extends Component {
    ...
    render() {
        ...
        return (<>
            ...
            {
                title[this.state.currentImage] !== null && title.length !== 0 && (
                    <View style={styles.overlay}>
                        <View>
                            ...
                            >
                                {title[this.state.currentImage].length > 95 ? 
                                    title[this.state.currentImage].slice(0, 95) + '...':
                                    title[this.state.currentImage]
                                }
                            </Text>
                        </View>
                    </View>
